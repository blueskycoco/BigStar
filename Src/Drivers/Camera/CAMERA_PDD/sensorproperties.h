...
//#include "\\Server-Develop\\Application\\Foundation\\Inc\\SysEvent.h"
#include "SysEvent.h"
...
{
    {
        ...
        6               // Maximum in (IRE * 100) units
    }
};

const static LONG BrightnessDefault = 3;
...
{
    {
        ...
        6               // Maximum as a gain factor multiplied by 100
    }
};

const static LONG ContrastDefault = 3;
...
{
    {
        ...
        6               // Maximum in (gain * 100) units
    }
};

const static LONG SaturationDefault = 3;
...
{
    {
        1,                  // SteppingDelta (range / steps)
        3,                  // Reserved
        0,                // Minimum in (degrees Kelvin)
        6                 // Maximum in degrees Kelvin)
    }
};

const static LONG WhiteBalanceDefault = 3;
...
const static LONG ZoomDefault = 100;
...
{
    {
        ...
        1                 // Maximum (in millimeter units. Values greater than 0 means 
...
// --Lenovo extend---------------------------------------------------------
static CSPROPERTY_STEPPING_LONG EffectRangeAndStep [] = 
{
    {
        1,                  // SteppingDelta (range / steps)
        0,                  // Reserved
...
const static LONG EffectDefault = 0;

static CSPROPERTY_MEMBERSLIST EffectMembersList [] = 
{
    {
        {
            CSPROPERTY_MEMBER_RANGES,
            sizeof (CSPROPERTY_STEPPING_LONG),
            SIZEOF_ARRAY (EffectRangeAndStep),
            0
        },
        (PVOID) EffectRangeAndStep,
     },
     {
        {
            CSPROPERTY_MEMBER_VALUES,
            sizeof (EffectDefault),
            1,
            CSPROPERTY_MEMBER_FLAG_DEFAULT
        },
        (PVOID) &EffectDefault,
...
static CSPROPERTY_VALUES EffectValues =
{
    {
        STATICGUIDOF (CSPROPTYPESETID_General),
        VT_I4,
    ...
    SIZEOF_ARRAY (EffectMembersList),
    EffectMembersList
};

// --Lenovo extend---------------------------------------------------------
static CSPROPERTY_STEPPING_LONG StillQualityRangeAndStep [] = 
{
    {
        1,                  // SteppingDelta (range / steps)
        0,                  // Reserved
...
static LONG StillQualityDefault = CAM_STILL_QUALITY_MAX; 

static CSPROPERTY_MEMBERSLIST StillQualityMembersList [] = 
{
    {
        {
            CSPROPERTY_MEMBER_RANGES,
            sizeof (CSPROPERTY_STEPPING_LONG),
            SIZEOF_ARRAY (StillQualityRangeAndStep),
            0
        },
        (PVOID) StillQualityRangeAndStep,
     },
     {
        {
            CSPROPERTY_MEMBER_VALUES,
            sizeof (StillQualityDefault),
            1,
            CSPROPERTY_MEMBER_FLAG_DEFAULT
        },
        (PVOID) &StillQualityDefault,
    }    
};

static CSPROPERTY_VALUES StillQualityValues =
{
    {
        STATICGUIDOF (CSPROPTYPESETID_General),
        VT_I4,
    ...
    SIZEOF_ARRAY (StillQualityMembersList),
    StillQualityMembersList
};

// --Lenovo extend---------------------------------------------------------
static CSPROPERTY_STEPPING_LONG GetDataDirectControlRangeAndStep [] = 
{
    {
        1,                  // SteppingDelta (range / steps)
        0,                  // Reserved
        0,                  // Minimum (means flash is turned off)
        256                 // Maximum (in millimeter units. Values greater than 0 means 
    }
};

static LONG GetDataDirectControlDefault = 0;

static CSPROPERTY_MEMBERSLIST GetDataDirectControlMembersList [] = 
{
    {
        {
            CSPROPERTY_MEMBER_RANGES,
            sizeof (CSPROPERTY_STEPPING_LONG),
            SIZEOF_ARRAY (GetDataDirectControlRangeAndStep),
            0
        },
        (PVOID) GetDataDirectControlRangeAndStep,
     },
     {
        {
            CSPROPERTY_MEMBER_VALUES,
            sizeof (GetDataDirectControlDefault),
            1,
            CSPROPERTY_MEMBER_FLAG_DEFAULT
        },
        (PVOID) &GetDataDirectControlDefault,
    }    
};

static CSPROPERTY_VALUES GetDataDirectControlValues =
{
    {
        STATICGUIDOF (CSPROPTYPESETID_General),
        VT_I4,
    ...
    SIZEOF_ARRAY (GetDataDirectControlMembersList),
    GetDataDirectControlMembersList
};

// --Lenovo extend---------------------------------------------------------
static CSPROPERTY_STEPPING_LONG StillFrameRequestRangeAndStep [] = 
{
    {
        1,                  // SteppingDelta (range / steps)
        0,                  // Reserved
        0,                  // Minimum (means flash is turned off)
        0x7fffffff                 // Maximum (in millimeter units. Values greater than 0 means 
    }
};

static LONG StillFrameRequestDefault = 0;

static CSPROPERTY_MEMBERSLIST StillFrameRequestMembersList [] = 
{
    {
        {
            CSPROPERTY_MEMBER_RANGES,
            sizeof (CSPROPERTY_STEPPING_LONG),
            SIZEOF_ARRAY (StillFrameRequestRangeAndStep),
            0
        },
        (PVOID) StillFrameRequestRangeAndStep,
     },
     {
        {
            CSPROPERTY_MEMBER_VALUES,
            sizeof (StillFrameRequestDefault),
            1,
            CSPROPERTY_MEMBER_FLAG_DEFAULT
        },
        (PVOID) &StillFrameRequestDefault,
    }    
};

static CSPROPERTY_VALUES StillFrameRequestValues =
{
    {
        STATICGUIDOF (CSPROPTYPESETID_General),
        VT_I4,
    ...
    SIZEOF_ARRAY (StillFrameRequestMembersList),
    StillFrameRequestMembersList
};

// --Lenovo extend---------------------------------------------------------
static CSPROPERTY_STEPPING_LONG PreviewFrameRequestRangeAndStep [] = 
{
    {
        1,                  // SteppingDelta (range / steps)
        0,                  // Reserved
...
static LONG PreviewFrameRequestDefault = 0;

static CSPROPERTY_MEMBERSLIST PreviewFrameRequestMembersList [] = 
{
    {
        {
            CSPROPERTY_MEMBER_RANGES,
            sizeof (CSPROPERTY_STEPPING_LONG),
            SIZEOF_ARRAY (PreviewFrameRequestRangeAndStep),
            0
        },
        (PVOID) PreviewFrameRequestRangeAndStep,
     },
     {
        {
            CSPROPERTY_MEMBER_VALUES,
            sizeof (PreviewFrameRequestDefault),
            1,
            CSPROPERTY_MEMBER_FLAG_DEFAULT
        },
        (PVOID) &PreviewFrameRequestDefault,
    }    
};

static CSPROPERTY_VALUES PreviewFrameRequestValues =
{
    {
        STATICGUIDOF (CSPROPTYPESETID_General),
        VT_I4,
    ...
    SIZEOF_ARRAY (PreviewFrameRequestMembersList),
    PreviewFrameRequestMembersList
};

// --Lenovo extend---------------------------------------------------------
static CSPROPERTY_STEPPING_LONG HWFeatureRangeAndStep [] = 
{
    {
        1,                  // SteppingDelta (range / steps)
        0,                  // Reserved
...
static LONG HWFeatureDefault = 0;

static CSPROPERTY_MEMBERSLIST HWFeatureMembersList [] = 
{
    {
        {
            CSPROPERTY_MEMBER_RANGES,
            sizeof (CSPROPERTY_STEPPING_LONG),
            SIZEOF_ARRAY (HWFeatureRangeAndStep),
            0
        },
        (PVOID) HWFeatureRangeAndStep,
     },
     {
        {
            CSPROPERTY_MEMBER_VALUES,
            sizeof (HWFeatureDefault),
            1,
            CSPROPERTY_MEMBER_FLAG_DEFAULT
        },
        (PVOID) &HWFeatureDefault,
    }    
};

static CSPROPERTY_VALUES HWFeatureValues =
{
    {
        STATICGUIDOF (CSPROPTYPESETID_General),
        VT_I4,
    ...
    SIZEOF_ARRAY (HWFeatureMembersList),
    HWFeatureMembersList
};

// --Lenovo extend---------------------------------------------------------
static CSPROPERTY_STEPPING_LONG WorkModeRangeAndStep [] = 
{
    {
        1,                  // SteppingDelta (range / steps)
        0,                  // Reserved
        0,                  // Minimum (means flash is turned off)
        2                 // Maximum (in millimeter units. Values greater than 0 means 
    }
};

static LONG WorkModeDefault = 0; // By default camera app is on forground

static CSPROPERTY_MEMBERSLIST WorkModeMembersList [] = 
{
    {
        {
            CSPROPERTY_MEMBER_RANGES,
            sizeof (CSPROPERTY_STEPPING_LONG),
            SIZEOF_ARRAY (WorkModeRangeAndStep),
            0
        },
        (PVOID) WorkModeRangeAndStep,
     },
     {
        {
            CSPROPERTY_MEMBER_VALUES,
            sizeof (WorkModeDefault),
            1,
            CSPROPERTY_MEMBER_FLAG_DEFAULT
        },
        (PVOID) &WorkModeDefault,
    }    
};

static CSPROPERTY_VALUES WorkModeValues =
{
    {
        STATICGUIDOF (CSPROPTYPESETID_General),
        VT_I4,
    ...
    SIZEOF_ARRAY (WorkModeMembersList),
    WorkModeMembersList
};
