...
#define CB_DMA_BUFFER 0x20000 // 128KB buffer // KYS
//#define CB_DMA_PAGE   0x1000  // we program DMA for 4KB pages // KYS
#define CB_DMA_PAGE   0x20000  // we program DMA for 128KB pages // KYS
