...
// The enumeration for factors is used in card detect interrupt handler of HSMMC ch0 on SMDK6410.
...
public:
	...
	BOOL IsOnlySDIOInterrupt();	// copied from CE6.0 by KYS
...
protected:
...
#endif
#ifdef _SMDK6410_CH0_EXTCD_
	// Prototype for a new function can detect whether card is presented of HSMMC ch0 on SMDK6410.
	...
	BOOL					isSDIOInterrupt;		// Copied from CE old version by KYS
