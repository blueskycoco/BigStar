...
40      tst     r0, #8
	...
	ldr     r1, =PT_1ST_ENTRY_CNB	 ; uncache/unbuffer/rw, PA base == 0x50000000
	str     r1, [r0]

	; uncached area.
	add     r0, r0, #0x0800	 ; PTE entry for VA = 0x0200.0000 , uncached
	ldr     r1, =PT_1ST_ENTRY_NCNB	 ; uncache/unbuffer/rw, base == 0x50000000
	str     r1, [r0]
...
VirtualStart
	...
	mov     sp, #0x80000000	; have to be modefied. refer oemaddrtab_cfg.inc,
	add     sp, sp, #0x2000000	; arbitrary initial super-page stack pointer
	add     sp, sp, #0x300000	; arbitrary initial super-page stack pointer
	add     sp, sp, #0x20000	; arbitrary initial super-page stack pointer
	b       main
