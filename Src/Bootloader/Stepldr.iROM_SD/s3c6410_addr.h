...
#define rPCLK_GATE	(*(volatile unsigned *)(SYSCON_BASE+0x34))		//SYSCON Memory Subsystem configuration
#define rSCLK_GATE	(*(volatile unsigned *)(SYSCON_BASE+0x38))		//SYSCON Memory Subsystem configuration
