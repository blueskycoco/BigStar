...
UINT32 System_GetAPLLCLK()
{
    ...
    {
        APLLCLK = ((FIN>>PLL_SVAL(pSysConReg->APLL_CON))/PLL_PVAL(pSysConReg->APLL_CON)*PLL_MVAL(pSysConReg->APLL_CON));
    }
    else
    {
        APLLCLK = FIN;
...
UINT32 System_GetMPLLCLK()
{
    ...
    MPLLCLK = ((FIN>>PLL_SVAL(pSysConReg->MPLL_CON))/PLL_PVAL(pSysConReg->MPLL_CON)*PLL_MVAL(pSysConReg->MPLL_CON));
